...
function NormalisedTTCRoute() {
  ...
  useEffect(() => {
    ...
    if (loc !== lower) {
      navigate(`/programs/${lower}/${course}${search}`, { replace: true });
    }
...
function NormalisedLocationRoute() {
  ...
  useEffect(() => {
    const lower = loc.toLowerCase();
    if (loc !== lower) {
      navigate(`/programs/${lower}${search}`, { replace: true });
    }
  }, [loc, navigate, search]);
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        {/* Online routes */}
        <Route path="online/live"      element={<OnlineYogaTeacherTraining />} />
        <Route path="online/recorded"  element={<OnlineYogaTeacherTraining />} />
        <Route path="online/workshops" element={<OnlineYogaTeacherTraining />} />

        {/* Misc named program routes — must come before dynamic :location routes */}
        ...
        {/* Short retreats — Mysuru detail pages */}
        ...
        {/* Short retreats — Bali detail pages */}
        ...
        {/* Short retreats — Rishikesh detail pages */}
        ...
        {/* Dynamic TTC routes — :location/:course before :location alone */}
        <Route path="programs/:location/:course" element={<NormalisedTTCRoute />} />
        <Route path="programs/:location"         element={<NormalisedLocationRoute />} />
