// import "./Styles/WelcometoOmbreath.css";
      ...
      <div className="yogaschool">
        <div className="yogaa">
          <div className="heading">
            <h1>Welcome To Ombreath</h1>
            <img src="./images/lg.png" alt="logo" />
          </div>

          <div className="join">
            <p style={{ lineHeight: "30px", fontSize: "18px" }}>
              Welcome to Ombreath, a premier yoga school dedicated to providing
              ...
              various parts of India, Ombreath Yoga Ashram is one of the
              ...
              the Ombreath entity, under Shreeram Yogshala, we also cater to
              diverse areas such as Pilgrimage, Events, Merchandise, Tours, and
              Community Services.
              <br />
              <br />
              Our goal is to create a holistic and inclusive approach to
              wellness that goes beyond just physical fitness. At Ombreath, we
