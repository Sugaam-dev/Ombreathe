          ...
          <div className="row">
            <div className="col-12">
              <h1 className={`yt-main-heading text-center mb-4 ${isVisible ? 'yt-visible' : ''}`}>
                Transformational experiences combining <span className="yt-highlight">silent meditation, multi-style yoga, and healing practices</span> to<br />
                give our guests a profound journey of self-discovery and inner peace
              </h1>

              <p className={`yt-subtitle text-center mb-5 ${isVisible ? 'yt-visible' : ''}`}>
                Our 7-day silent meditation retreat blends five yoga styles (Ashtanga, Hatha, Nidra, Vipassana, Vinyasa) 
                with guided mindfulness practices, sound healing, and transformative silence in magical Bali.
              </p>
            </div>
          </div>
          ...
          <div className="row mt-5">
            <div className="col-12">
              <div className="text-center">
                <h3 className="mb-4" style={{ color: '#4a5568' }}>What Makes Our Silent Retreat Special</h3>
                <div className="row g-4">
                  <div className="col-md-4">
                    <div className="p-4">
                      <h5 style={{ color: '#6a5acd' }}>Silent Serenity</h5>
                      <p style={{ color: '#718096' }}>
                        Embrace the power of silence to cultivate inner peace through guided meditation and mindful practices
                      </p>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="p-4">
                      <h5 style={{ color: '#6a5acd' }}>Multi-Style Yoga</h5>
                      <p style={{ color: '#718096' }}>
                        Experience five different yoga styles to deepen your practice and explore various approaches to wellness
                      </p>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="p-4">
                      <h5 style={{ color: '#6a5acd' }}>Healing & Nature</h5>
                      <p style={{ color: '#718096' }}>
                        Sound healing sessions, nature immersion, and silent beach walks in Bali's magical spiritual energy
                      </p>
                    </div>
                  </div>
                </div>
