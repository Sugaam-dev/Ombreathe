  ...
  const features = [
    {
      ...
      title: "6 nights modern Balinese accommodation",
      subtitle: "with A/C, pool access & peaceful environment"
    },
    {
      icon: (
        <div className="ytp-feature-icon">
      ...
      title: "Daily silent meditation & multi-style yoga",
      subtitle: "Ashtanga, Hatha, Nidra, Vipassana & Vinyasa"
    },
    {
      icon: (
        <div className="ytp-feature-icon">
      ...
      title: "3 daily plant-based sattvic meals",
      subtitle: "organic, fresh & nutritionally balanced"
    },
    {
      icon: (
        <div className="ytp-feature-icon">
      ...
      title: "Sound healing & inner child healing",
      subtitle: "transformative therapeutic sessions"
    },
    {
      icon: (
        <div className="ytp-feature-icon ytp-bonus-icon">
          <div className="ytp-bonus-text">SILENCE</div>
        </div>
      ),
      title: "Silent beach walks & nature immersion",
      subtitle: "connect deeply with Bali's tranquil energy"
    }
  ];
          ...
          <div className={`ytp-main-content ${isVisible ? 'ytp-visible' : ''}`}>
            <div className="row g-5">
              <div className="col-lg-6">
                ...
                <h6 className="ytp-section-title">YOGALAYAA SILENT RETREAT</h6>
                
                <h1 className="ytp-main-heading">
                  Join us for a transformative<br />
                  <span className="ytp-highlight">7-day silent meditation</span><br />
                  & multi-style yoga retreat in magical Bali
                </h1>
