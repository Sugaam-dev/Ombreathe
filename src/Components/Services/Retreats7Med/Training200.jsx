              ...
              <div className="text-center">
                ...
                <div className="mb-4 mb-md-5">
                  <h6 className="text-uppercase mb-2 mb-md-3" 
                    ...
                    7 Day Multi-Style & Meditation Retreat<br />
                    In Magical Bali, Indonesia<br />
                    With Yogalayaa
                  </h6>
                </div>
                ...
                <div className="mb-4 mb-md-5">
                  ...
                  <p className="lead mb-0" 
                    ...
                    7 days of transformative silent meditation and multi-style yoga practice
                  </p>
                </div>
                ...
                <div className="mb-4 mb-md-5">
                 ...
                 $1099
                  ...
                  <p className="mb-0" 
                    ...
                    *Early bird offer - includes accommodation, meals & all sessions
                  </p>
                </div>
              ...
              <div className="row align-items-start">
                ...
                <div className="col-12 col-lg-6 mb-4 mb-lg-0">
                  <h2 className="mb-4" 
                    ...
                    Your silent retreat<br />
                    includes...
                  </h2>
                  
                  <div className="mb-3">
                    <h5 style={{ color: '#2E3A87', fontWeight: '500' }}>Silent meditation experience:</h5>
                    <ul className="list-unstyled" style={{ color: '#6B7280' }}>
                      <li className="mb-2">• 6 nights accommodation with A/C & pool</li>
                      <li className="mb-2">• Daily silent meditation and yoga sessions</li>
                      <li className="mb-2">• 5 yoga styles: Ashtanga, Hatha, Nidra, Vipassana, Vinyasa</li>
                      <li className="mb-2">• Sound healing and inner child healing sessions</li>
                      <li className="mb-2">• Traditional Kecak dance performance</li>
                      <li className="mb-2">• Free yoga kit & certificate of completion</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="col-12 col-lg-6">
                  ...
                  <div className="text-start text-lg-end">
                    <p className="mb-1" 
                      ...
                      Highly rated for excellent sattvic food and experienced teachers.
                    </p>
                    <p className="mb-1" 
                       style={{ 
                         color: '#6B7280', 
                      ...
                      Modern Balinese accommodations in lush Ubud surroundings.
                    </p>
                    <p className="mb-0" 
                       style={{ 
                         color: '#2E3A87', 
                      ...
                      Deepen your meditation practice and connect with your inner self
                    </p>
                  </div>
                </div>
              </div>
