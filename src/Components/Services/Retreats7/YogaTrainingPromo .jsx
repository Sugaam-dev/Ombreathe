  ...
  const features = [
    {
      ...
      title: "6 nights luxury accommodation with",
      subtitle: "private room, A/C, and pool access"
    },
    {
      icon: (
        <div className="ytp-feature-icon">
      ...
      title: "Daily adventure activities: rafting,",
      subtitle: "jungle trekking, temple visits & more"
    },
    {
      icon: (
        <div className="ytp-feature-icon">
      ...
      title: "3 daily healthy organic meals",
      subtitle: "vegetarian/vegan/gluten-free options"
    },
    {
      icon: (
        <div className="ytp-feature-icon">
      ...
      title: "Daily yoga sessions, meditation &",
      subtitle: "relaxation in stunning natural settings"
    },
    {
      icon: (
        <div className="ytp-feature-icon ytp-bonus-icon">
          <div className="ytp-bonus-text">KECAK</div>
        </div>
      ),
      title: "Traditional Kecak dance performance",
      subtitle: "& authentic Balinese cultural experiences"
    }
  ];
          ...
          <div className={`ytp-main-content ${isVisible ? 'ytp-visible' : ''}`}>
            <div className="row g-5">
              <div className="col-lg-6">
                ...
                <h6 className="ytp-section-title">YOGALAYAA BALI RETREAT</h6>
                
                <h1 className="ytp-main-heading">
                  Join us for an immersive<br />
                  <span className="ytp-highlight">7-day adventure & yoga</span><br />
