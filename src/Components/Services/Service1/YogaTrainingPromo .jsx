...
//         </div>
//       ),
//       title: "20 days / 19 nights in a boutique resort in",
//       subtitle: "Ubud, Bali"
//     },
//     {
//       icon: (
...
//         </div>
//       ),
//       title: "Daily delicious vegan/vegetarian meals a",
//       subtitle: "day (buffet style)"
//     },
//     {
//       icon: (
//         <div className="ytp-feature-icon ytp-bonus-icon">
//           <div className="ytp-bonus-number">200</div>
//         </div>
//       ),
//       title: "BONUS: lifelong access to our Online",
//       subtitle: "200hr Yoga Alliance course"
//     }
//   ];
...
//                 <h6 className="ytp-section-title">ABOUT THE TRAINING</h6>
                
//                 <h1 className="ytp-main-heading">
//                   Join us for an immersive<br />
//                   <span className="ytp-highlight">20 days 200-hour</span> Yoga Alliance<br />
...
//                       alt="Yoga group practice circle"
//                     />
//                   </div>
          ...
          <div className={`ytp-main-content ${isVisible ? 'ytp-visible' : ''}`}>
            <div className="row g-5">
              <div className="col-lg-6">
                ...
                <h1 className="ytp-main-heading">
                  Join us for an immersive<br />
                  <span className="ytp-highlight">25 days 200-hour</span> Ashtanga Vinyasa<br />
                ...
                {/* <div className="mt-4">
                  <p style={{ color: '#6c757d', fontSize: '0.9rem', fontStyle: 'italic' }}>
                    ✨ Free pick up from Ngurah Rai International Airport to Yogalayaa<br />
                    ✨ Family-operated school for a safe and nurturing environment<br />
                    ✨ 1 special emotional blockage treatment session included
                  </p>
                </div> */}
              </div>
