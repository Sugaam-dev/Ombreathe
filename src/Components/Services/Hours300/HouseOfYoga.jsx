        ...
        <div className="container py-5">
          <div className="row">
            <div className="col-lg-8 mx-auto">
              ...
              <p className="mb-4">
                Welcome to Yogalayaa's 300-Hour Advanced Yoga Teacher Training - a premier program for experienced practitioners 
              ...
              <p className="mb-0">
                At Yogalayaa, we believe that advanced yoga practice is a lifelong journey of self-discovery and service to others. 
