...
const shaktiSadhanaData = {
  ...
  final: {
    ...
    description: "At Yogalayaa Academy, we prioritize your spiritual growth, safety, and transformative experience. Join the Shakti Sadhana program and connect with the divine feminine energy while taking your spiritual journey to the next level.",
    benefits: [
      {
