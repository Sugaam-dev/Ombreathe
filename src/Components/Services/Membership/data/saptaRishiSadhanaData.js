...
const saptaRishiSadhanaData = {
  ...
  hero: {
    ...
    400 Hours Certification with Ombreath`,
  ...
  certifications: [
    ...
    },
    {
      ...
      alt: "Ombreath Advanced Wisdom Certification"
    }
  ],
  ...
  transformation: {
    ...
    subtitle: "At Ombreath, our advanced program transmits authentic Vedic wisdom through direct experience at sacred ashrams, ancient practices, and guidance from traditional lineage holders"
  },
  ...
  final: {
    ...
    description: "At Ombreath Academy, we offer the most authentic and comprehensive Vedic wisdom training available. Our program connects you directly with the living lineages of the great Rishis while providing practical tools for applying ancient knowledge in contemporary life.",
    benefits: [
      {
