      ...
      <div style={overlayStyle}>
        <div className="container text-center py-5">
          ...
          <div className="row mt-5">
            ...
            <div className="col-md-2">
              <div style={statStyle}>12 Days</div>
        ...
        <div className="container py-5">
          <div className="row">
            <div className="col-lg-8 mx-auto">
              ...
              <p className="mb-4">
                Welcome to Yogalayaa's 100-Hour Foundation Yoga Teacher Training - a perfect introduction for beginners 
              ...
              <p className="mb-0">
                At Yogalayaa, we believe that every yoga journey begins with strong foundations. Join us in this nurturing 
