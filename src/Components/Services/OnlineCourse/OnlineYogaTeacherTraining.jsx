...
const OnlineYogaTeacherTraining = () => {
  // FIXED: Removed 'isVisible' as it was assigned but never used
  ...
  // FIXED: Wrapped courseData in useMemo so it remains stable
  // and doesn't trigger unnecessary re-renders in hooks.
  const courseData = useMemo(
    () => ({
      ...
      hero: {
        ...
        description:
          "Complete 200-Hour Yoga Alliance Certified Teacher Training with live virtual classes, mentorship, and lifetime support",
      ...
      pricing: {
        ...
        inclusions:
          "Yoga Alliance Certified • Payment plans available • 30-day guarantee",
      },
      features: [
        {
          icon: "🎥",
        ...
        },
        {
          ...
          subtitle:
            "Learn from E-RYT 500 certified teachers with 15+ years experience",
        },
        {
          icon: "📱",
      ...
      schedule: {
        ...
        description:
          "Designed for working professionals with live sessions and self-paced study",
        format: [
          {
            type: "Live Sessions",
  ...
  // FIXED: Added courseData.features to dependency array
  useEffect(() => {
    const timeouts = [];
  ...
  // FIXED: Added courseData.theme.buttonShadow to dependency array
  const handleMouseEnter = useCallback(
    (e) => {
      e.target.style.transform = "translateY(-2px)";
      e.target.style.boxShadow = `0 12px 35px ${courseData.theme.buttonShadow}`;
    },
    [courseData.theme.buttonShadow],
  );
    ...
    <div className="oc-container">
      ...
      <section className="oc-hero-section">
        ...
        <div className="oc-hero-content">
          <div className="oc-hero-subtitle">{courseData.hero.subtitle}</div>
          <h1 className="oc-hero-title">{courseData.hero.title}</h1>
          <p className="oc-hero-description">{courseData.hero.description}</p>
        ...
        <div className="oc-container-width">
          ...
          <div className="oc-pricing-grid">
            <div className="oc-pricing-card featured">
              ...
              <div>
                <span className="oc-pricing-amount">
                  {courseData.pricing.earlybird.amount}
                </span>
                <span className="oc-pricing-original">
                  {courseData.pricing.earlybird.originalPrice}
                </span>
              </div>
              <p className="oc-pricing-savings">
                {courseData.pricing.earlybird.savings}
              </p>
            ...
            <div className="oc-pricing-card">
              ...
              <div>
                <span className="oc-pricing-amount">
                  {courseData.pricing.standard.amount}
                </span>
                <span className="oc-pricing-original">
                  {courseData.pricing.standard.originalPrice}
                </span>
              </div>
              <p className="oc-pricing-savings">
                {courseData.pricing.standard.savings}
              </p>
              <ul className="oc-pricing-features">
      ...
      <section className="oc-section">
        <div className="oc-container-width">
          <div className="oc-section-header">
            ...
            <p className="oc-section-subtitle">
              {courseData.schedule.description}
            </p>
          </div>
      ...
      <section className="oc-final-cta">
        <div className="oc-final-content">
          <h2 className="oc-final-title">
            Ready to Begin Your Teaching Journey?
          </h2>
          <p className="oc-final-description">
            Join thousands of graduates who have transformed their lives and are
            now sharing the gift of yoga with others around the world.
          </p>
          <div className="oc-final-offer">
            <h3>Early Bird Offer Ends Soon!</h3>
            <p>Save $1,000 on your teacher training</p>
            <div className="oc-final-urgency">
              ⏰ Only 12 spots remaining in our next cohort
            </div>
          </div>
          <div className="oc-final-buttons">
            ...
            <button className="oc-btn-secondary" onClick={contact}>
              Learn More
            </button>
          </div>
          <div className="oc-final-guarantee">
            🔒 Secure checkout • 💰 30-day money-back guarantee • 📱 Instant
            access
          </div>
        </div>
      </section>
