    ...
    >
      {!isVisible ? (
        ...
        <Suspense fallback={
          ...
          <LazyYouTubeEmbed
            videoId="_xLrirWP-S0"
            title="Yoga School By Yogalayaa"
...
function Utube() {
  ...
  const content = {
    title: "Yoga School By Yogalayaa",
    subtitle: "Awaken Your Inner Yogi and Embrace the Magic of Rishikesh, Bali, and McLeod Ganj with Yogalayaa Yoga Ashram",
    description: `Welcome to Yogalayaa Yoga Ashram, a leading yoga school with centers in Rishikesh, Bali, and McLeod Ganj. Our Yoga Teacher Training courses are Yoga Alliance accredited and offer a comprehensive, immersive learning experience for practitioners of all levels.
