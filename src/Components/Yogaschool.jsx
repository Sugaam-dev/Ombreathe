...
{/* remove it and add slider with bali rishikesh and himalayaa  */}
          <div className="join">
            ...
            <p>
              ...
              eveniet quae qui rerum obcaecati, saepe sed optio repellat
              asperiores modi rem aspernatur deleniti quis natus neque fugiat!
              Est, odit, voluptatem aperiam magni provident possimus architecto
              ad veniam recusandae, quidem animi accusamus cumque molestiae odio
              explicabo iste libero nobis ea vel labore! Consectetur nam nostrum
              error natus alias ducimus saepe nesciunt praesentium corporis
              dolorum unde, quod repudiandae laborum quisquam molestias sint,
              numquam, optio temporibus ullam dolorem. Voluptatibus sunt nulla,
              temporibus pariatur asperiores dolores magni ratione facere harum,
              dolor, fugiat et in at aperiam suscipit cupiditate nemo qui
              explicabo cum quisquam? Non similique dignissimos sit suscipit
          ...
          <div className="box">
            <div className="box1">
              <img src="./images/yoga-school.webp" alt="img1" />
            </div>
            <div className="box2">
              <p>
...
<div className="boxcontent">
  <div className="item1">
    <div className="itemlogo">
      <img src="https://livingyogaschool.com/images/about-icon1.svg" alt="" />
    </div>
  <div className="item2">
  ...
  <div className="item1">
    <div className="itemlogo">
      <img src="https://livingyogaschool.com/images/about-icon3.svg" alt="" />
    </div>
  <div className="item2">
  ...
  <div className="item1">
    <div className="itemlogo">
      <img src="https://livingyogaschool.com/images/about-icon4.svg" alt="" />
    </div>
  <div className="item2">
  <h3>Ancient Wisdom</h3>
  <p>

Yoga is the journey into the self</p>
  </div>
  </div>
  <div className="item1">
    <div className="itemlogo">
      <img src="https://livingyogaschool.com/images/about-icon2.svg" alt="" />
    </div>
  <div className="item2">
  <h3>Traditional Methodology</h3>
  <p>

Natural Healing for body & mind</p>
  </div>
  </div>
</div>
            </div>
